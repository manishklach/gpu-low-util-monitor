                    ...
                    writer.writerow(
                        {
                            ...
                            "entity_kind": report.sample.identity.entity_kind,
                            "parent_uuid": report.sample.identity.parent_uuid,
                            "mig_instance_id": report.sample.identity.mig_instance_id,
                            "mig_profile": report.sample.identity.mig_profile,
            ...
            rows.append(
                " | ".join(
                    [
                        ...
                        report.sample.identity.entity_kind,
